...
<body>
 ...
 <main>
    ...
    <div class="mailaddress">
        <label>メールアドレス
            <input type="mail address" name="mail address">
        </label>
    </div>
      <div class="loginpass">
      <label>パスワード
         <input placeholder="半角英数8～12文字" type="password"></input>
    </label>
    <div class="rekey">
        <label>パスワード再入力
            <input placeholder="上記のものを再入力" type="password"></input>
        </label>
    </div>
     <input class="decisionbotton" type="submit" name="seal" value="確定する">
    </div>
